    ...
    <>
      <Box sx={{ display: 'flex' }}>
        <Box sx={{ minWidth: '200px' }}>
          <NavList>
            <NavList.Item aria-current="page">Overview</NavList.Item>
            <NavList.Group title="Runtime">
              <NavList.Item>Servers</NavList.Item>
              <NavList.Item>Services</NavList.Item>
              <NavList.Item>Proxy</NavList.Item>
            </NavList.Group>
            <NavList.Group title="IAM">
              ...
              <NavList.Item>
                ...
                <NavList.SubNav>
                  ...
                  <NavList.Item>Scopes</NavList.Item>
                </NavList.SubNav>
              </NavList.Item>
            </NavList.Group>
          </NavList>
