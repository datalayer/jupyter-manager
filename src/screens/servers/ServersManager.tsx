    ...
    <>
      <Box sx={{ display: 'flex' }}>
        <Box sx={{ minWidth: '200px' }}>
          <NavList>
            <NavList.Item>All servers</NavList.Item>
            <NavList.Item>
              Server extensions
              <NavList.SubNav>
                <NavList.Item>Home</NavList.Item>
                <NavList.Item aria-current="page">Configuration</NavList.Item>
                <NavList.Item>Monitoring</NavList.Item>
                <NavList.Item>Status</NavList.Item>
              </NavList.SubNav>
            </NavList.Item>
          </NavList>
        </Box>
